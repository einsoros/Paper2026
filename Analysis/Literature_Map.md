...
> [V17 삭제] Hobfoll(1989) / Hobfoll et al.(2018) — COR 이론. 매개변수 무력감 폐기로 근거 상실.

### H1 실증 보강 (귀속 모호성 → 평가 불확실성)
...
| Dell'Acqua et al. (2023) | Organization Science | AI 협업이 기여 식별 어렵게 함 실증 |
| Pan et al. (2026) | HRM | AI 성과평가 맥락 + Layer 5 차별화 공유 |
| Pan & Froese (2023) | HRMR | AI+HRM 학제간 리뷰 |
| Budhwar et al. (2022) | IJHRM | AI+HRM 도전과 기회 |
...
| 논문 | 저널 | 역할 | 본 연구와의 차별점 |
| --- | --- | --- | --- |
| He et al. (2025) ⚠️ | CSCW | [V7] 핵심 인용 — 창작 맥락 한정 한계를 차별점으로 활용 | 창작 맥락 → 본 연구는 조직 성과평가 맥락 |
| Starke et al. (2022) | Big Data & Society | Algorithmic fairness 리뷰 | AI 알고리즘 자체 공정성 → 본 연구는 AI 협업 후 인간 평가 공정성 |
...
- Dell'Acqua et al. (2023) — AI 협업이 기여 식별을 어렵게 함
- Pan et al. (2026) — AI 성과평가 연구 현황
- Pan & Froese (2023), Budhwar et al. (2022) — AI+HRM 리뷰·의제
- He et al. (2025) ⚠️ — 기존 연구 gap (보조 인용)
- Jiang et al. (2023), Tang et al. (2022) — 인접 영역 한계 제시용

### 2. 이론적 배경 (Theoretical Background)

**2.1 인간-AI 협업과 사회물질성**
- Orlikowski (2007), Leonardi (2011)

**2.2 귀인이론과 성과 기여 귀속 모호성 (IV + IV→MV) [V17]**
- Weiner (1985) — 핵심 이론(귀인 3차원 + 기대원리)
- Martinko et al. (2019), Hewett et al.
...
- [V13] MV 무력감 — Hobfoll·Spreitzer 추가 [V17에서 제거]
- [V14] Layer 5 비교군 5편 추가
